        ...
        Begin FormHeader
            ...
            Begin
                ...
                Begin ComboBox
                    ...
                    RowSource ="SELECT [ID], [Company], [Contact Name], [E-mail Address] FROM [Suppliers Extende"
                        "d] WHERE [ID]<>Nz(Form![ID],0) ORDER BY [Company]; "
                    ColumnWidths ="0;2880;2880;2880"
                    Tag ="GoToRecord~TableOrQueryName=[Suppliers Extended]~SourceID=ID~Column1=Company~Col"
                ...
                Begin CommandButton
                    ...
                    TabIndex =1
                    ForeColor =16777215
                    Name ="cmdEmailSupplier"
                    Caption ="&E-mail Supplier"
                    FontName ="Trebuchet"
                    ...
                    OnClickEmMacro = Begin
                        ...
                        Begin
                            Comment ="_AXL:<?xml version=\"1.0\" encoding=\"UTF-16\" standalone=\"no\"?>\015\012<UserI"
                                "nterfaceMacro For=\"cmdEmailSupplier\" xmlns=\"http://schemas.microsoft.com/offi"
                                "ce/accessservices/2009/11/application\" xmlns:a=\"http://schemas.microsoft.com/o"
                                "ffice/accessservices/2009/11/f"
                        End
                        Begin
                            Comment ="_AXL:orms\"><Statements><Action Name=\"OnError\"/><Action Name=\"EMailDatabaseOb"
                                "ject\"><Argument Name=\"To\">=[E-mail Address] &amp; IIf(Nz([E-mail Address])&lt"
                                ";&gt;\"\",\" [\" &amp; [E-mail Address] &amp; \"]\")</Argument></Action><Conditi"
                                "onalBlock><If><Condition>["
                        End
                        Begin
                            Comment ="_AXL:MacroError].[Number]&lt;&gt;0</Condition><Statements><Action Name=\"Message"
                                "Box\"><Argument Name=\"Message\">=[MacroError].[Description]</Argument></Action>"
                                "</Statements></If></ConditionalBlock></Statements></UserInterfaceMacro>"
                        End
                    End
                    BackStyle =0
                    ...
                    OnClickEmMacro = Begin
                        ...
                        Begin
                            Comment ="_AXL:on Name=\"GoToRecord\"><Argument Name=\"Record\">New</Argument></Action><Ac"
                                "tion Name=\"GoToControl\"><Argument Name=\"ControlName\">Company</Argument></Act"
                ...
                Begin TextBox
                    ...
                    ControlSource ="=IIf(DCount(\"*\",\"[Suppliers Extended]\",\"[ID]<>\" & Nz([ID],0) & \" And [Con"
                        "tact Name] = '\" & Replace(Nz([Contact Name]),\"'\",\"''\") & \"'\")>0,\"Possibl"
                        "e Duplicate\",\"\")"
                    FontName ="Trebuchet"
                    Tag ="DuplicatesWarning~TableOrQueryName=[Suppliers Extended]~FieldName=Contact Name~I"
                        "D=ID"
                    HorizontalAnchor =1
        ...
        Begin Section
            ...
            Begin
                ...
                Begin Label
                    ...
                    Width =1875
                    Height =60
                    Name ="cmdEmailSupplier_LayoutLabel"
                    Tag =";DoNotResize;"
